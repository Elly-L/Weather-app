const API_KEY = "aaf24b72a506d1b340293042f47b0d8f" // Updated OpenWeatherMap API key
...
export class WeatherService {
  ...
  static async getWeatherAlerts(city: string) {
    // This would typically use a weather alerts API
    // For now, we'll simulate based on forecast data
    try {
